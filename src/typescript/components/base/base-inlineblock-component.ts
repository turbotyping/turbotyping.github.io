...
export abstract class BaseInlineBlockHtmlComponent extends BaseHtmlComponent {
  ...
  _toHtml(): string {
    return `<div id="${this.containerId}" style="display: inline-block">${this.__toHtml()}</div>`;
  }
