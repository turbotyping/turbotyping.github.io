export default [
  ...
  {
    text:
      'No matter how much you may think that recounting issues that have caused you problems over the last few years, it will not help you to move towards creating a better or a new life',
    reference: 'https://www.wow4u.com/lifeq2/',
    author: 'Catherine Pulsifer',
  },
  {
    text:
      'If you are in retirement, or are starting to look forward to it, we have some good news for you: turns out the peak ages for happiness are later in life',
    reference: 'https://www.wow4u.com/lifeq2/',
  ...
  {
    text:
      'If you strive for perfect love, you will learn to see the face of God in your spouse, your children, and your fellow human. This should be our goal as humankind',
    reference: 'https://www.wow4u.com/lifeq2/',
  ...
  {
    text:
      'Treating the other person as you would like to be treated is a golden rule that not only applies to general life encounters but also in negotiations',
    reference: 'https://www.wow4u.com/lifeq2/',
    author: 'Jim Berry',
  },
  {
  ...
  {
    text:
      'Whine and complain about everything in your life. Loudly. At every given opportunity. This will assure that you never get anything better, because we tend to get what we focus on',
    reference: 'https://www.wow4u.com/lifeq2/',
    author: 'Jack Killian',
  },
  {
  ...
  {
    text:
      "I don't organize or structure life just because it's my job or because I want things to look good from the outside. I do these things because I want a life that is rich, sweet, and uncomplicated",
    reference: 'https://www.wow4u.com/lifeq2/',
    author: 'Emily Ley',
  },
  {
  ...
  {
    text:
      'Many people choose to be generous towards others and empower them as opportunities arise. That becomes a mantra for them, a way of life, a philosophy and a doctrine, a life companion and a collection of self-regulating instincts that become etched on their subconscious mind',
    reference: 'https://www.wow4u.com/lifeq2/',
