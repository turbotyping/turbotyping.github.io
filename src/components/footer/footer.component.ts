  ...
  toHtml() {
    return /* html */ `
      <footer>
        ...
        <p>For any suggestion, please feel free to create a <b><a href="https://github.com/ah-keyboard/devkeyboard.github.io/issues/new" target="_blank">ticket</a></b> in our github repository and we will try to add it ASAP</p>
